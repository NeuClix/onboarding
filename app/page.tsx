  ...
  return (
    <div className="flex min-h-screen flex-col items-center">
      ...
      <main className="flex-1 w-full">
        ...
        {/* Services Section */}
        <section id="services" className="bg-muted py-16 md:py-24 w-full">
        ...
        {/* Gallery Section */}
        <section id="gallery" className="bg-muted py-16 md:py-24 w-full">
        ...
        <section id="testimonials" className="py-16 md:py-24 w-full">
          <div className="container space-y-8">
            <div className="space-y-4 text-center">
        ...
        {/* Booking Section */}
        <section id="booking" className="bg-gradient-to-r from-pink-50 to-purple-50 py-16 md:py-24 w-full">
          <div className="container">
